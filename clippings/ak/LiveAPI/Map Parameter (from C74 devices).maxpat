...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 281.0, 121.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 41.0, 38.0, 18.0 ],
					"text" : "Map"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 65.0, 72.0, 18.0 ],
					"text" : "Persistent ID"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 81.0, 152.0, 40.0 ],
					"text" : "< The parameter's ID is stored within the Live set, and restored when the set is reloaded."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 257.0, 47.0, 18.0 ],
					"text" : "Store ID"
				}
...
,
					"patching_rect" : [ 301.0, 81.0, 85.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 57.0, 19.0, 18.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 229.0, 241.0, 103.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 257.0, 81.0, 18.0 ],
					"text" : "Parameter ID >"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 137.0, 96.0, 18.0 ],
					"text" : "<-----------------------"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 277.0, 33.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 175.0, 151.0, 39.0, 15.0 ],
					"prototypename" : "onoff",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 221.0, 33.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 127.0, 151.0, 39.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
,
					"patching_rect" : [ 221.0, 57.0, 75.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 57.0, 149.0, 118.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -9.0, -9.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 229.0, 201.0, 91.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 127.0, 111.0, 87.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -9.0, -9.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 229.0, 161.0, 91.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 127.0, 79.0, 87.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -9.0, -9.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 229.0, 121.0, 91.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 127.0, 47.0, 87.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 129.0, 152.0, 40.0 ],
					"text" : "A bpatcher box that contains a Max patcher file: the M4L.Chooser abstraction"
				}
...
,
					"patching_rect" : [ 229.0, 305.0, 83.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 293.0, 281.0, 31.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 183.0, 23.0, 31.0, 15.0 ],
					"prototypename" : "onoff",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 281.0, 40.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 124.0, 23.0, 40.0, 18.0 ],
					"text" : "Target",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 169.0, 152.0, 107.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 238.5, 271.0, 400.5, 271.0, 400.5, 69.0, 310.5, 69.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-40::obj-25" : [ "ListItems", "ListItems", 0 ],
			"obj-41::obj-25" : [ "ListItems[1]", "ListItems", 0 ],
			"obj-31" : [ "Map", "Map", 0 ],
			"obj-42::obj-25" : [ "ListItems[2]", "ListItems", 0 ],
			"obj-30" : [ "Enable", "Enable", 0 ],
			"obj-23" : [ "MapOnce", "MapOnce", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "M4L.Chooser.maxpat",
