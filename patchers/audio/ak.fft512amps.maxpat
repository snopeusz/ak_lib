...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 210.0, 130.0, 89.0, 25.0 ],
					"style" : "",
					"text" : "getattr name"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 245.0, 221.0, 152.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 274.0, 119.0, 25.0 ],
					"style" : "",
					"text" : "jit.poke~ 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 100.0, 64.0, 23.0 ],
					"style" : "",
					"text" : "512 bins"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 175.5, 172.0, 40.0 ],
					"style" : "",
					"text" : "we need only the first half of a spectrum = 256 bins"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 190.0, 179.0, 48.0, 25.0 ],
					"style" : "",
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 245.0, 263.0, 149.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 160.0, 69.0, 25.0 ],
					"style" : "",
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 125.0, 119.0, 25.0 ],
					"style" : "",
					"text" : "fft~ 512 512"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 208.5, 89.0, 50.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 359.0, 30.0, 30.0 ],
					"style" : ""
				}
