...
,
		"rect" : [ 217.0, 108.0, 394.0, 435.0 ],
		"bgcolor" : [ 0.9152, 0.915173, 0.915188, 1.0 ],
		"editing_bgcolor" : [ 0.9152, 0.915173, 0.915188, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 57.0, 155.0, 78.0 ],
					"style" : "",
					"text" : "collects messages received in the second inlet;\non bang in the first inlet dump all messages and clear buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 383.0, 150.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.0, 103.0, 38.0, 23.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 127.0, 322.5, 91.0, 23.0 ],
					"style" : "",
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dump" ],
					"patching_rect" : [ 127.0, 161.0, 54.0, 23.0 ],
					"style" : "",
					"text" : "t dump"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.499992, 161.0, 82.0, 23.0 ],
					"style" : "",
					"text" : "t clear bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 28.0, 69.0, 99.0, 23.0 ],
					"style" : "",
					"text" : "sel clear dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 189.0, 248.0, 86.0, 23.0 ],
					"style" : "",
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 189.0, 161.0, 86.0, 23.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 189.0, 215.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 127.0, 287.0, 51.0, 23.0 ],
...
, 			{
				"box" : 				{
					"comment" : "(bang) dump and clear buffer",
					"id" : "obj-32",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 17.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"comment" : "messages to be buffered",
					"id" : "obj-33",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "buffered messages",
					"id" : "obj-34",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 379.5, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 77.5, 139.0, 136.5, 139.0 ],
					"source" : [ "obj-14", 1 ]
				}
