...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.25, 97.0, 132.0, 25.0 ],
					"presentation_rect" : [ 54.25, 111.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 258.5, 157.0, 42.0 ],
					"style" : "",
					"text" : "(rather exotic object, but maybe there will be a case for its usage in future...)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 144.25, 302.0, 27.0, 25.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 226.0, 150.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 110.0, 227.0, 107.0 ],
					"style" : "",
					"text" : "ak.route1 [atom atom atom ...]\n\n- like [route] but outputs all matching messages through first outlet, and all that don't match through the second."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 234.75, 354.0, 43.0, 25.0 ],
					"style" : "",
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.25, 354.0, 62.0, 25.0 ],
					"style" : "",
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.25, 219.0, 62.0, 25.0 ],
					"style" : "",
					"text" : "zl slice 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 40.75, 330.5, 244.25, 330.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 40.75, 330.5, 153.75, 330.5 ],
					"source" : [ "obj-23", 0 ]
				}
